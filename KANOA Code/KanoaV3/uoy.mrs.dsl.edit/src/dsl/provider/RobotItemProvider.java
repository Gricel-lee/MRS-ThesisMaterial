...
/**
 * This is the item provider adapter for a {@link dsl.Robot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RobotItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInitLocPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Init Loc feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInitLocPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Robot_initLoc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Robot_initLoc_feature", "_UI_Robot_type"),
				 DslPackage.Literals.ROBOT__INIT_LOC,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addVelocityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Robot_velocity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Robot_velocity_feature", "_UI_Robot_type"),
				 DslPackage.Literals.ROBOT__VELOCITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DslPackage.Literals.ROBOT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DslPackage.Literals.ROBOT__CAPABILITIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.ROBOT__CAPABILITIES,
				 DslFactory.eINSTANCE.createCapability()));
	}
