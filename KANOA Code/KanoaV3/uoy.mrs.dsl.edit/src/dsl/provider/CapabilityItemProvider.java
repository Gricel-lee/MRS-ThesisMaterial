...
/**
 * This is the item provider adapter for a {@link dsl.Capability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CapabilityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Capability_at_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Capability_at_feature", "_UI_Capability_type"),
				 DslPackage.Literals.CAPABILITY__AT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DslPackage.Literals.CAPABILITY__TIME,
				 true,
				 false,
				 false,
	...
	protected void addSuccessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Capability_success_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Capability_success_feature", "_UI_Capability_type"),
				 DslPackage.Literals.CAPABILITY__SUCCESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Capability_type") + " " + capability.getTime();
	}
