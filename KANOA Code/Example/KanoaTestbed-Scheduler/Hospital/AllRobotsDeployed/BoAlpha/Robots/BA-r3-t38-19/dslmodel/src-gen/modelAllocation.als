...
abstract sig at1,at2,at2Reef,at1Reef,at2Rock,at1Rock extends AtomicTask {}
...
// ----------------CONSTRAINTS:
 ...
 fact { no r:r1 | #(r.capability.do ) > 19}
 fact { no r:r2 | #(r.capability.do ) > 19}
 fact { no r:r3 | #(r.capability.do ) > 19}
