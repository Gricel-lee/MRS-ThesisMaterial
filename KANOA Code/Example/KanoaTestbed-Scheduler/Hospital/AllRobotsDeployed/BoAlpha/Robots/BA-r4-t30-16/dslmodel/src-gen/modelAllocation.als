...
{disj[capability ,  Capability-r4at1-r4at2-r4at1Rock-r4at2Rock-r4at1Reef-r4at2Reef]}
...
{all d:do | d in at1}
lone sig r4at2 extends Capability{}
{all d:do | d in at2}
lone sig r4at1Rock extends Capability{}
{all d:do | d in at1Rock}
lone sig r4at2Rock extends Capability{}
{all d:do | d in at2Rock}
lone sig r4at1Reef extends Capability{}
{all d:do | d in at1Reef}
lone sig r4at2Reef extends Capability{}
{all d:do | d in at2Reef}

// ----------------ATOMIC TASKS:

abstract sig at1Rock,at2,at1Reef,at2Rock,at1,at2Reef extends AtomicTask {}
...
fact{all a:at1 | #do.a=4}	// number of robots needed
...
// ----------------CONSTRAINTS:
 ...
 fact { no r:r4 | #(r.capability.do ) > 16}

// ----------------RUN COMMAND:

run TaskAllocation for
7 Int, 22 Capability, exactly 30 AtomicTask, 4 Robot