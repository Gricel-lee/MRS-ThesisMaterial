...
{disj[capability ,  Capability-r1at1-r1at2-r1at1Rock-r1at2Rock-r1at1Reef-r1at2Reef-r1ate]}
lone sig r2 extends Robot{}
{disj[capability ,  Capability-r2at1-r2at2-r2at1Rock-r2at2Rock-r2at1Reef-r2at2Reef-r2ate]}
lone sig r3 extends Robot{}
{disj[capability ,  Capability-r3at1-r3at2-r3at1Rock-r3at2Rock-r3ate]}
...
{all d:do | d in at2Reef}
lone sig r2ate extends Capability{}
{all d:do | d in ate}
...
abstract sig at2Reef,at2Rock,ate,at2,at1Rock,at1,at1Reef extends AtomicTask {}
fact{all a:at2Reef | #do.a=1}	// number of robots needed
fact{all a:at2Rock | #do.a=1}	// number of robots needed
fact{all a:ate | #do.a=3}	// number of robots needed
...
one sig ate_31 extends ate{} {x=10 y=20} //do at location l1c
...
7 Int, 19 Capability, exactly 31 AtomicTask, 3 Robot