...
{disj[capability ,  Capability-r4at1Rock-r4at2Rock]}
lone sig r5 extends Robot{}
{disj[capability ,  Capability-r5at1Rock-r5at2Rock]}
...
{all d:do | d in at2Rock}
lone sig r5at1Rock extends Capability{}
{all d:do | d in at1Rock}
lone sig r5at2Rock extends Capability{}
{all d:do | d in at2Rock}

// ----------------ATOMIC TASKS:

abstract sig at2Rock,at1Rock extends AtomicTask {}
fact{all a:at2Rock | #do.a=5}	// number of robots needed
fact{all a:at1Rock | #do.a=5}	// number of robots needed
...
6 Int, 10 Capability, exactly 2 AtomicTask, 5 Robot