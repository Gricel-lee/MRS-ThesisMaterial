...
{disj[capability ,  Capability-r7at2-r7at3-r7at4]}
lone sig r8 extends Robot{}
{disj[capability ,  Capability-r8at2-r8at3-r8at4]}
lone sig r9 extends Robot{}
{disj[capability ,  Capability-r9at2-r9at3-r9at4]}
...
{all d:do | d in at1}
lone sig r7at2 extends Capability{}
{all d:do | d in at2}
lone sig r7at3 extends Capability{}
{all d:do | d in at3}
lone sig r7at4 extends Capability{}
{all d:do | d in at4}
lone sig r8at2 extends Capability{}
{all d:do | d in at2}
lone sig r8at3 extends Capability{}
{all d:do | d in at3}
lone sig r8at4 extends Capability{}
{all d:do | d in at4}
lone sig r9at2 extends Capability{}
{all d:do | d in at2}
lone sig r9at3 extends Capability{}
{all d:do | d in at3}
lone sig r9at4 extends Capability{}
{all d:do | d in at4}

// ----------------ATOMIC TASKS:

abstract sig at4,at2,at3,at1 extends AtomicTask {}
...
5 Int, 20 Capability, exactly 14 AtomicTask, 8 Robot